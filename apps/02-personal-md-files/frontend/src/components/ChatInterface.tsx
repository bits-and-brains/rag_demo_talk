...
const ChatInterface: React.FC = () => {
  ...
  const phpApiUrl = import.meta.env.VITE_PHP_API_URL || 'http://localhost:8005';
  const nodeApiUrl = import.meta.env.VITE_NODE_API_URL || 'http://localhost:8006';
  const pythonApiUrl = import.meta.env.VITE_PYTHON_API_URL || 'http://localhost:8007';
  const golangApiUrl = import.meta.env.VITE_GOLANG_API_URL || 'http://localhost:8008';
    ...
    <div className="flex flex-col h-screen max-w-4xl mx-auto p-4">
      <div className="mb-4">
        <div className="flex justify-between items-center mb-2">
          <h1 className="text-2xl font-bold">Personal MD Files</h1>
          <button
