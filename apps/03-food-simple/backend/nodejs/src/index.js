...
app.use(cors({
  origin: process.env.CORS_ALLOWED_ORIGINS || 'http://localhost:3002'
}));
...
app.get('/api/embedding-models', chatController.embeddingModels);
app.get('/api/vector-search-providers', chatController.vectorSearchProviders);
