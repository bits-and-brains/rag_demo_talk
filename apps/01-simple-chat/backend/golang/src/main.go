...
import (
	...
	"github.com/smoogie/rag_demo/apps/01-simple-chat/backend/golang/src/controllers"
...
func main() {
	...
	chatController := controllers.NewChatController(llmService)
